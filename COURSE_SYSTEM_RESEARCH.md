...
**Decisao**: Construir domain customizado `src/apps/courses/` seguindo a arquitetura existente do projeto (BaseModel, service layer, PublicID), usando Joanie e Smart Learn como referencia arquitetural.
