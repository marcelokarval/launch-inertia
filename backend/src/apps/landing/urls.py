...
urlpatterns = [
    ...
    # ── Content pages (config-driven Inertia pages) ─────────────────
    path("lembrete-bf/", views.lembrete_bf_page, name="lembrete_bf"),
    path("recado-importante/", views.recado_importante_page, name="recado_importante"),
