...
> Arquivo histórico.
>
> Este documento registra a análise do fluxo de captura em uma fase anterior do projeto. O source of truth atual para o fluxo de capture está em `frontends/docusaurus/docs/`.
