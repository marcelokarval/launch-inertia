      ...
      <div className="space-y-6 text-sm leading-relaxed text-gray-700">
        ...
        <Section title="1. Acceptance of Terms">
          <p>
            ...
            you are prohibited from using or accessing this site. You must be at least 18 years
            old to use our services.
          </p>
        </Section>

        <Section title="2. Subscription Service Description">
          <p className="mb-2">We provide a subscription-based educational platform offering:</p>
        ...
        <Section title="3. Billing and Payment Terms">
          <p className="mb-2"><strong>Subscription Billing:</strong></p>
          <ul className="mb-3 list-disc space-y-1 pl-6">
            <li>All prices are in US Dollars (USD)</li>
            <li>Subscriptions automatically renew monthly/annually unless cancelled</li>
          ...
          <p>
            <strong>Price Changes:</strong> We reserve the right to modify subscription fees.
            You will receive 30 days advance notice of any price increases.
          </p>
        </Section>

        <Section title="4. No Refund Policy">
          <p className="mb-2"><strong>Digital Product — No Refunds:</strong></p>
          <ul className="list-disc space-y-1 pl-6">
            <li>Due to immediate access to our digital content library upon subscription,
                NO REFUNDS are available once your subscription is activated</li>
            <li>Free trials (if offered) can be cancelled before converting to paid subscription</li>
            <li>Cancellation stops future charges but does not refund the current billing period</li>
            <li>You retain access to content until the end of your current paid period</li>
            <li>Chargebacks may result in immediate account termination</li>
          </ul>
        </Section>

        <Section title='5. Cancellation Policy (FTC Compliance)'>
          <p className="mb-2"><strong>Easy Cancellation &mdash; &ldquo;Click to Cancel&rdquo;:</strong></p>
          <ul className="list-disc space-y-1 pl-6">
        ...
        <Section title="6. Account Registration and Security">
          <p>
            ...
            (b) maintain and update your information; (c) maintain the security of your
            password and account; (d) notify us immediately of any unauthorized use;
        ...
        <Section title="7. Intellectual Property Rights">
          <p>
            ...
            images, audio clips, video, data, and software, is our property or licensed to us
            and is protected by United States and international copyright laws. You may not
        ...
        <Section title="9. Disclaimer of Warranties">
          <p>
            ...
            WARRANTIES OF ANY KIND. WE DO NOT GUARANTEE SPECIFIC RESULTS OR SUCCESS. Educational
            content is for informational purposes only and does not constitute professional advice.
            Individual results depend entirely on personal effort, dedication, and external factors
            beyond our control.
          </p>
        </Section>
        ...
        <Section title="10. Limitation of Liability">
          <p>
            ...
            OR REVENUES. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID FOR THE
        ...
        <Section title="11. Arbitration Agreement">
          <p>
            ...
            under the American Arbitration Association rules rather than in court, except that
            you may assert claims in small claims court. You waive your right to participate
            in class actions. This arbitration agreement survives termination of these Terms.
          </p>
        </Section>
        ...
        <Section title="12. Governing Law">
          <p>
            ...
            the United States and the State of Delaware, without regard to its conflict of
            law provisions. You consent to the exclusive jurisdiction of the federal and
        ...
        <Section title="13. Platform Compliance">
          <p>
            We comply with the terms of service of third-party platforms including Meta
            (Facebook/Instagram), WhatsApp Business API, Google Ads, and Stripe. Your use
            of our services through these platforms is also subject to their respective
            terms and policies.
          </p>
        </Section>
        ...
        <Section title="14. Modifications to Terms">
          <p>
            ...
            be notified via email or prominent notice on our website 30 days before taking
            effect. Continued use after changes constitutes acceptance of the new terms.
          </p>
        </Section>

        <Section title="15. Contact Information">
          <p>
            For questions about these Terms of Service or to exercise your rights,
