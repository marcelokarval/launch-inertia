...
/**
 * WhatsApp group CTA button with pulse animation and social proof.
 *
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <a
        ...
        className="group relative inline-flex items-center gap-3 rounded-xl bg-green-500 px-8 py-4 text-lg font-bold text-white shadow-lg transition-all hover:bg-green-600 hover:shadow-xl active:scale-[0.98]"
      >
        {/* Pulse ring */}
        <span className="absolute inset-0 animate-ping rounded-xl bg-green-400 opacity-20" />
